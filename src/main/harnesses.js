...
const HARNESSES = [
  {
    ...
    billing: 'free',
    billingLabel: 'Included in the free plan',
    note: 'Runs on the free plan, with traffic routed through Claude Code Router instead of an Anthropic sign-in.',
    builtInModels: [],
  },
  {
    id: 'codex-app',
    ...
    billing: 'free',
    billingLabel: 'Included in the free plan',
    note: 'Runs on the free plan, with traffic routed through Claude Code Router instead of an OpenAI sign-in.',
    builtInModels: [],
  },
  {
    id: 'claude-code',
